...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://torrestraining.pt/osteopathy" },
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Osteopathy | Torres Training by Fabio Torres",
      ...
      <section className="w-full space-y-16 px-4 py-24">
        ...
        <InView margin="0px" className="mx-auto max-w-4xl space-y-4">
          ...
          <p className="text-lg leading-relaxed tracking-tight text-muted-foreground lg:text-xl lg:leading-relaxed">
            ...
            Embrace a tailored approach to wellness, addressing the root causes
            of your discomfort for lasting recovery. Book your free consultation
