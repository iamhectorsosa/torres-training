...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://torrestraining.pt/personal-training" },
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Personal Training | Torres Training by Fabio Torres",
  image: "https://torrestraining.pt/personal-training/opengraph-image.png",
  description:
    "Elevate your fitness journey with personalized 1-1 training sessions tailored to your goals, preferences, and fitness level",
};
    ...
    <>
      ...
      <section className="w-full space-y-16 px-4 py-24">
        ...
        <InView margin="0px" className="mx-auto max-w-4xl space-y-4">
          ...
          <p className="text-lg leading-relaxed tracking-tight text-muted-foreground lg:text-xl lg:leading-relaxed">
            Kickstart your fitness transformation today. From tailored
            assessments to bespoke workout plans and one-on-one guidance,
            we&apos;re here to help you reach your goals. Schedule your free
            consultation now and begin your journey to a stronger, healthier
            you.
          </p>
